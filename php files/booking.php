...
<head>
	...
	<link href="src/styles/booking.css" rel="stylesheet"  type="text/css">
		...
		<header>
			<div class="wrapper">
				...
				<nav>
					...
					<a href="#" class="navtab">CONTACT</a>
					<a href="#" class="navtab">ABOUT US</a>
					<a href="#" class="navtab">CAREERS</a>
					<a href="#" class="navtab">PRODUCTS</a>
				</nav>
...
<table border="1" style="float: right; margin-right: -600px;">  
   <tr>  
