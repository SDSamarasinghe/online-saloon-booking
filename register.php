...
<html>
<head>
  <link rel="stylesheet" type="text/css" href="src/styles/regis.css">
</head>
<body>

  <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
    <a><img src="images/previous.png" width="80px" style="margin-bottom: -205px; cursor: pointer;" id="previous"></a>
<center><h3 style="font-size: 100px; color: #fff; margin-right: 50px;">Register</h3></center>
